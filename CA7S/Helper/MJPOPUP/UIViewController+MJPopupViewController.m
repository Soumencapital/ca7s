...
#define kMJPopupTouchable @"kMJPopupTouchable"
...
-(BOOL)isTouchable {
    NSNumber *number = objc_getAssociatedObject(self, kMJPopupTouchable);
    return [number boolValue];
}

-(void)setIsTouchable:(BOOL)isTouchable {
    NSNumber *number = [NSNumber numberWithBool: isTouchable];
    objc_setAssociatedObject(self, kMJPopupTouchable, number, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
}
