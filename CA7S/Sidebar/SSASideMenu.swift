...
class SSASideMenu: UIViewController, UIGestureRecognizerDelegate {
    ...
    @IBInspectable var contentViewShadowOpacity: Float = 0.5
    @IBInspectable var contentViewShadowRadius: Float = 15.0
    ...
    fileprivate func showMenuViewController(_ side: SSASideMenuSide, menuViewController: UIViewController) {
        ...
        contentViewContainer.addSubview(menuViewContainer)
    ...
    fileprivate func presentMenuViewContainerWithMenuViewController(_ menuViewController: UIViewController?) {
        ...
        if UIScreen.main.bounds.size.height > 736 {
            ...
            menuViewContainer.frame = CGRect(x: 0, y: 105, width: view.frame.size.width-95, height: view.frame.size.height/1.3)
        }
        else {
            
            menuViewContainer.frame = CGRect(x: 0, y: 80, width: view.frame.size.width-95, height: view.frame.size.height/1.3)
        }
    ...
    fileprivate func setupContentViewShadow() {
        ...
        if contentViewShadowEnabled {
            let layer: CALayer = menuViewContainer.layer
